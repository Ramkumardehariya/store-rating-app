    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600 mb-6">
          You don't have a store registered yet. Please contact admin to set up your store.
        </p>
        ...
        <div className="card">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-medium text-blue-600">+5 this week</span>
            </div>
      ...
      <div className="card">
        ...
        <div className="p-6">
                ...
                {ratings.length > 0 ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600">
                      Customer ratings will appear here once they start rating your store.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="card">
                  ...
                  <div className="h-64 bg-gray-100 rounded-lg flex items-center justify-center">
                    <p className="text-gray-500">Rating trends chart would be displayed here</p>
                  </div>
                </div>
                ...
                <div className="card">
                  ...
                  <div className="h-64 bg-gray-100 rounded-lg flex items-center justify-center">
                    <p className="text-gray-500">Customer insights chart would be displayed here</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {activeTab === 'responses' && (
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <h3 className="text-lg font-semibold text-gray-900">Manage Responses</h3>
                <div className="text-sm text-gray-600">
                  {ratings.filter(r => !r.owner_response).length} pending responses
                </div>
              </div>
